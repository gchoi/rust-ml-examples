...
```bash
# CUDA
$ cargo run --release --features cuda -- --prompt 'Write helloworld code in Rust' --sample-len 150

# Metal
$ cargo run --release --features metal -- --prompt 'Write helloworld code in Rust' --sample-len 150
```
