...
```bash
## CUDA
# default args, use  llava-hf/llava-v1.6-vicuna-7b-hf. image-file is required^_^
$ cargo run --features cuda -- \
  --image-file "../assets/llava_logo.png" \
  --prompt "is this a cat?" --hf
# use liuhaotian/llava-v1.6-vicuna-7b, tokenizer setup should be done
$ cargo run --features cuda -- \
