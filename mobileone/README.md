...
```bash
# CUDA
$ cargo run --release --features cuda -- --image ../assets/bike.jpg --which s2

# Metal
$ cargo run --release --features metal -- --image ../assets/bike.jpg --which s2

# Accelerate
$ cargo run --release --features accelerate -- --image ../assets/bike.jpg --which s2
```
